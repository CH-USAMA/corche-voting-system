            ...
            <div class="row justify-centent-evenly">
                <div class="col-6 cus_divStyle">
                    ...
                    <div class="table_div container-fluid">
                        <embed src="{{asset('images/dummy.pdf')}}" type="application/pdf" width="555px" height="500px"/>
                    </div>
                </div>
                <div class="col-6 cus_divStyle">
                    <div class="container-fluid d-flex justify-content-between">
                    ...
                    <div class="table_div container-fluid document_div">
                        ...
                        <table class="table table-bordered" style=" border-radius: 25px !important;">
                            <thead>
                                ...
                                <th scope="col" class="cus_p">Azuay</th>
                                <th scope="col">Zona</th>
                                <th scope="col" class="cus_p">Banos</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                <th scope="row">Parroquia</th>
                                <td class="cus_p">Banos</td>
                                <td>Circunscripcion</td>
                                <td class="cus_p">Ciscunscripcion Rural</td>
                                </tr>
                                <tr>
                                <th scope="row">Canton</th>
                                <td class="cus_p">Cuenca</td>
                                <td>Junta No.</td>
                                <td class="cus_p">3F</td>
                                </tr>
                            </tbody>
                            </table>
                        </div>
                        ...
                        <div class="row respoinsive_div">
                            ...
                            <div class="total_Votes d-flex">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="custom_style_p">350 <span class="badge badge-bg">75%</span></p>
                            ...
                            <div class="total_Votes d-flex">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="custom_style_p">350 <span class="badge badge-bg">100%</span></p>
                                </div>
                            ...
                            <div class="total_Votes d-flex">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="custom_style_p">350 <span class="badge badge-bg">20%</span></p>
                                </div>
